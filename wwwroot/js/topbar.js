...
* Licensed under the MIT License */; (function (window, document) {
    'use strict'; (function () {
    ...
    }, options = { autoRun: true, barThickness: 7, barColors: { '0': 'rgba(26,  188, 156, .9)', '.25': 'rgba(52,  152, 219, .9)', '.50': 'rgba(241, 196, 15,  .9)', '.75': 'rgba(230, 126, 34,  .9)', '1.0': 'rgba(211, 84,  0,   .9)' }, shadowBlur: 10, shadowColor: 'rgba(0,   0,   0,   .6)' }, repaint = function () {
    ...
    if (typeof module === 'object' && typeof module.exports === 'object') { module.exports = topbar } else if (typeof define === 'function' && define.amd) { define(function () { return topbar }) } else { this.topbar = topbar }
